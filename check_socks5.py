...
args = argparse.ArgumentParser(description='check proxy list')
args.add_argument('inputFile', help='inputFile')
args.add_argument('outputPath', help='outputPath')
args.add_argument('-t', '--threads', default=1, help='Treads to launch')
args.add_argument('-o', '--timeout', default=10, help='Timeout')
